...
public class SlidersController : ControllerBase
{
    ...
    public SlidersController(SliderService service)
    {
        _service = service;
    }
    ...
    [HttpGet]
    [AllowAnonymous]
    [ProducesResponseType(typeof(IReadOnlyList<SliderDto>), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(typeof(SliderDto), StatusCodes.Status201Created)]
    public async Task<IActionResult> Create([FromBody] SliderCreateDto dto, CancellationToken cancellationToken = default)
    {
    ...
    [ProducesResponseType(typeof(SliderDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update(Guid id, [FromBody] SliderUpdateDto dto, CancellationToken cancellationToken = default)
    {
